...
This directory contains Python scripts for managing frontend translations in B-PDF. These tools help analyze, merge, validate, and manage translations against the en-GB golden truth file.

## Current Format: TOML

**B-PDF uses TOML format for translations** in `frontend/public/locales/{lang}/translation.toml`.
...
- Uses GPT-5 with specialized prompts for B-PDF
...
- Specialized system prompts for B-PDF translations
